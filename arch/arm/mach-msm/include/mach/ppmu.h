/* linux/arch/arm/mach-msm/include/mach/ppmu.h
*
...
void msm_ppc_reset(struct msm_ppmu_hw *ppmu);
void msm_ppc_start(struct msm_ppmu_hw *ppmu);
void msm_ppc_stop(struct msm_ppmu_hw *ppmu);
void msm_ppc_setevent(struct msm_ppmu_hw *ppmu,
                                 unsigned int evt_num);
unsigned long long msm_ppc_update(struct msm_ppmu_hw *ppmu);
