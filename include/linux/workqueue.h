...
#undef bp_alloc_workqueue
#ifdef CONFIG_LOCKDEP_SUPPORT
#define bp_alloc_workqueue(fmt, flags, max_active, args...)		\
({									\
...
#undef bp_alloc_ordered_workqueue
#define bp_alloc_ordered_workqueue(fmt, flags, args...) \
bp_alloc_workqueue(fmt, WQ_UNBOUND | __WQ_ORDERED | (flags), 1, ##args)
#define bp_destroy_workqueue backport_destroy_workqueue
